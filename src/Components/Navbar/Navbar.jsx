...
const Navbar = () => {
    ...
    return (
        <div className='navbar flex mt-30 mt-10 border-b pb-5'>
            ...
            {/*</ul>*/}
            <ul className='nav-menu flex flex-row gap-10 mx-auto items-center font-bold'>
                <li>Shop <hr style={{ backgroundColor: '#f00', height: '2px'}}/></li>
                <li>Men <hr style={{ backgroundColor: '#f00', height: '2px'}}/></li>
                <li>Women <hr style={{ backgroundColor: '#f00', height: '2px'}}/></li>
                <li>Kids <hr style={{ backgroundColor: '#f00', height: '2px'}}/></li>
            </ul>
            <div className='nav-login-cart flex mr-32 gap-5'>
                {/*<Link to='/login'><button >Login</button></Link>*/}
                {/*<Link to='/cart'><img className='scale-50' src={cart_icon} alt='cart'/></Link>*/}
                <button>Login</button>
                <img className='scale-50' src={cart_icon} alt=""/>
